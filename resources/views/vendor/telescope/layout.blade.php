...
<div id="telescope" v-cloak>
    ...
    <div class="container mb-5">
        <div class="d-flex align-items-stretch py-4 header">
            ...
            <router-link to="/monitored-tags" class="btn mr-3 btn-muted d-flex align-items-center py-2" title="Monitoring">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="icon" fill="currentColor">
            ...
            <a href="/admin" class="btn btn-muted d-flex align-items-center py-2" title="Back to admin">
              Back to Admin
            </a>
        </div>
